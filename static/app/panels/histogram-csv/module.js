...
function (angular, app, $, _, kbn, moment, timeSeries) {
  ...
  var module = angular.module('kibana.panels.histogramcsv', []);
  app.useModule(module);

  module.controller('histogramcsv', function($scope, $q, querySrv, dashboard, filterSrv) {
    $scope.panelMeta = {
      modals : [
        {
          description: "Inspect",
      ...
      status  : "Stable",
      description : "A bucketed time series chart of the current query or queries using CSV. Uses the "+
