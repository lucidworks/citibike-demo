...
def create_fields(args):
    ...
    fields.create(["name=start_station_name_idx", "field_type=text_en", "indexed=true", "stored=true", "facet=true", "include_in_results=true"], FIELDS_URL)
    ...
    fields.create(["name=end_station_name_idx", "field_type=text_en", "indexed=true", "stored=true", "facet=true", "include_in_results=true"], FIELDS_URL)
